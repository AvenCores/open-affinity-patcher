...
Утилита патчит `libaffinity.dll` по смещению `0x00440681` и заменяет:
...
`3.2.1.4425` (Enterprise, формат EXE)

Скачать версию `3.2.1.4425`: [Telegram](https://t.me/avencoreschat/525984) | [Официальный сайт](https://www.affinity.studio/download)

⚠️ **Важно**: скачивайте именно **Enterprise версию в формате EXE**, не обычную версию в формате MSIX

Поведение:

- Если версия ровно `3.2.1.4425`, предупреждение не показывается
- Если версия ниже `3.2.1.4425`, выводится предупреждение о возможной некорректной работе патчера
- Если версия отличается от `3.2.1.4425`, но выше нее, предупреждение тоже будет показано
...
- Используйте на свой риск при патчинге версий, отличающихся от `3.2.1.4425`
